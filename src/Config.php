...
final class Config
{
    ...
    public const FORCE_BASE_URL = 'https://www.encanta.fi/demo';
    public const YOUR_DOMAIN = 'www.encanta.fi';
    public const APP_PATH = '/demo';
    ...
    */
    ...
    // путь приложения (оставляем demo)
    public const APP_PATH          = '/demo';

    // куда возвращать пользователя после отмены/успеха
    public const BACK_URL          = 'https://encanta.fi/';
